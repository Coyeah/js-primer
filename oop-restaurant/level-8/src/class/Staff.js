...
class Waiter extends Staff {
  ...
  getOrder (orderList) {
    console.log(">> Waitert " + this.name + " Order " + orderList + ".");
  }

  serverDishes () {
    console.log(">> Waiter " + this.name + " Server.");
  }
}
...
class Chef extends Staff {
  ...
  cooking (orderItem) {
    ...
    console.log(">> Chef " + this.name + " Cooking " + orderItem.name + ".");
  }

  finishedCook () {
    console.log(">> Chef " + this.name + " Done.");
  }
}
