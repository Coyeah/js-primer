...
class Customer {
  ...
  order (menu) {
    let i = Math.floor(Math.random() * 10);
    console.log(">> Customer " + this.id + " Order " + menu[i].name + ".");
    this.orderList.push(menu[i].name);
  }

  eat () {
    console.log(">> Customer " + this.id + " Eating.");
  }

  sitdown () {
    console.log(">> Customer " + this.id + " Sitdown.");
  }

  leave () {
    console.log(">> Customer " + this.id + " Leaving.");
  }
}
